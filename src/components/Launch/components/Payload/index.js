...
export class Payload extends React.Component {
    ...
    payloadMap = () => {
        return this.props.payloads.map((payload, index) => {
            return (
                <li key={"payload " + index}>
    ...
    render() {
        ...
        return (
            <div className="payloadList">
                ...
                <button onClick={this.showPayloads} className="payloadButton">
                    {this.state.isShowingPayloads === false ? (
                        <>Show Payloads</>
                    ) : (
                        <>Hide Payloads</>
                    )}
                ...
                <ol>
                    {this.state.isShowingPayloads === true && this.payloadMap()}
                </ol>
            </div>
        );
    }
