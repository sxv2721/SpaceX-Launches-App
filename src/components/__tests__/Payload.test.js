...
describe("Payloads Render", () => {
    ...
    it("should render payload data", () => {
        ...
        console.log(wrapper.find(".payloadDesc"));
        ...
        expect(wrapper.contains(<dd className="payloadDesc">{payload[0].payload_id}</dd>)).toEqual(true);
        expect(wrapper.contains(<dd className="payloadDesc">{payload[0].payload_type}</dd>)).toEqual(true);
        expect(wrapper.contains(<dd className="payloadDesc">{payload[0].nationality}</dd>)).toEqual(true);
    })
})